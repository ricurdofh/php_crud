		...
		<body onload="listarVendedores();">
			...
			<nav id="main-nav">		
				<ul class="container_12">
					<li class="current">
						<ul>
							<li><a href="index.php" title="Clientes">Clientes</a></li>
							<li class="current"><a href="vendedores.php" title="Vendedores">Vendedores</a></li>
						</ul>
					</li>
				</ul>
			</nav>
			...
			<div id="status-bar"><div class="container_12">
				...
				<ul id="breadcrumb">
					<li id="agregar_vendedor"><a href="javascript:void(0)" title="Agregar Vendedor" onclick="addVendedor();">Agregar Vendedor</a></li>
				</ul>
